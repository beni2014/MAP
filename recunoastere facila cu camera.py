...
faceCascade = cv2.CascadeClassifier(r"C:\Users\beni\Desktop\python\haarcascade_frontalface_default.xml")
...
while rval:
    ...
    for (x, y, w, h) in faces:
        cv2.rectangle(flipHorizontal, (x, y), (x+w, y+h), (255, 80, 180), 2)
